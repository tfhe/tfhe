...
void TorusPolyFunctions<TORUS>::MultNaive_plain_aux(
...
template<typename TORUS>
void TorusPolyFunctions<TORUS>::MultNaive_aux(
    TORUS *__restrict result,
    const INT_TYPE *__restrict poly1,
    const TORUS *__restrict poly2,
    const int32_t N,
 ...
 */
template<typename TORUS>
void TorusPolyFunctions<TORUS>::MultNaive(
    ...
    Allocator alloc)
{
    ...
    TorusPolyFunctions<TORUS>::MultNaive_aux(result->coefs, poly1->coefs, 
...
// R of size = 2*size-1
template<typename TORUS>
void TorusPolyFunctions<TORUS>::Karatsuba_aux(
    TORUS *R,
    const INT_TYPE *A,
    const TORUS *B,
    const int32_t size,
...
template<typename TORUS>
void TorusPolyFunctions<TORUS>::MultKaratsuba(
    TorusPolynomial<TORUS> *result,
    const IntPolynomial<INT_TYPE> *poly1,
    const TorusPolynomial<TORUS> *poly2,
    const PolynomialParameters *params,
...
// poly1, poly2 and result are polynomials mod X^N+1
template<typename TORUS>
void TorusPolyFunctions<TORUS>::AddMulRKaratsuba(
    TorusPolynomial<TORUS> *result,
    const IntPolynomial<INT_TYPE> *poly1,
    const TorusPolynomial<TORUS> *poly2,
    const PolynomialParameters *params,
...
// poly1, poly2 and result are polynomials mod X^N+1
template<typename TORUS>
void TorusPolyFunctions<TORUS>::SubMulRKaratsuba(
    TorusPolynomial<TORUS> *result,
    const IntPolynomial<INT_TYPE> *poly1,
    const TorusPolynomial<TORUS> *poly2,
    const PolynomialParameters *params,
