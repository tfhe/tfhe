...
public:
    ...
    BigTorus(const BigIntParams *params, Allocator *alloc);

    void destroy(const BigIntParams *params, Allocator *alloc);
 ...
 * @return real number
*/
double to_double(const BigTorus *a, const BigIntParams *b);
