...
int main(int argc, char** argv) {
  ...
  TorusPolynomial<Torus>* b = new_TorusPolynomial<Torus>(N);
  TorusPolynomial<Torus>* resNaive = new_TorusPolynomial<Torus>(N);
  TorusPolynomial<Torus>* resFFT = new_TorusPolynomial<Torus>(N);
  TorusPolynomial<Torus>* resKaratsuba = new_TorusPolynomial<Torus>(N);
