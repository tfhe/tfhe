...
namespace {
	...
	FakeLagrangeHalfCPolynomial* reps = (FakeLagrangeHalfCPolynomial*) malloc(nbelts*sizeof(FakeLagrangeHalfCPolynomial));
...
inline void fake_LagrangeHalfCPolynomialAddMul(LagrangeHalfCPolynomial* accum, const LagrangeHalfCPolynomial* a, const LagrangeHalfCPolynomial* b) {
