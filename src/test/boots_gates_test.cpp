...
#include "../libtfhe/boot-gates.cpp"
	    ...
	    void binary_gate_test(
		    ...
		    void (*boots_gate)(LweSample*,const LweSample*, const LweSample*, const TFheGateBootstrappingCloudKeySet*)
		    ) {
	    ...
	    void ternary_gate_test(
		    ...
		    void (*boots_gate)(LweSample*,const LweSample*, const LweSample*, const LweSample*, const TFheGateBootstrappingCloudKeySet*)
		    ) {
