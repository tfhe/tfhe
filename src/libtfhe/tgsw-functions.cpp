...
#if defined INCLUDE_ALL || defined INCLUDE_TGSW_ALLOC_FUNCTION
#undef INCLUDE_TGSW_ALLOC_FUNCTION
EXPORT TGswSample* alloc_TGswSample() {
    return (TGswSample*) malloc(sizeof(TGswSample));
}
#endif

#if defined INCLUDE_ALL || defined INCLUDE_TGSW_ALLOC_ARRAY_FUNCTION
#undef INCLUDE_TGSW_ALLOC_ARRAY_FUNCTION
...
#if defined INCLUDE_ALL || defined INCLUDE_TGSW_FREE_FUNCTION
#undef INCLUDE_TGSW_FREE_FUNCTION
EXPORT void free_TGswSample(TGswSample* ptr) {
    free(ptr);
}
#endif

#if defined INCLUDE_ALL || defined INCLUDE_TGSW_FREE_ARRAY_FUNCTION
#undef INCLUDE_TGSW_FREE_ARRAY_FUNCTION
...
//}
#if defined INCLUDE_ALL || defined INCLUDE_TGSW_INIT_ARRAY_FUNCTION
#undef INCLUDE_TGSW_INIT_ARRAY_FUNCTION
EXPORT void init_TGswSample_array(int nbelts, TGswSample* obj, const TGswParams* params) {
    for (int i=0; i<nbelts; i++) {
	init_TGswSample(obj+i,params);
    }
}
#endif
...
//    obj->~TGswSample();
//}
#if defined INCLUDE_ALL || defined INCLUDE_TGSW_DESTROY_ARRAY_FUNCTION
#undef INCLUDE_TGSW_DESTROY_ARRAY_FUNCTION
EXPORT void destroy_TGswSample_array(int nbelts, TGswSample* obj) {
    for (int i=0; i<nbelts; i++) {
	destroy_TGswSample(obj+i);
    }
}
#endif
...
#if defined INCLUDE_ALL || defined INCLUDE_TGSW_NEW_FUNCTION
#undef INCLUDE_TGSW_NEW_FUNCTION
EXPORT TGswSample* new_TGswSample(const TGswParams* params) {
    TGswSample* obj = alloc_TGswSample();
    init_TGswSample(obj,params);
    return obj;
}
#endif

#if defined INCLUDE_ALL || defined INCLUDE_TGSW_NEW_ARRAY_FUNCTION
#undef INCLUDE_TGSW_NEW_ARRAY_FUNCTION
...
#if defined INCLUDE_ALL || defined INCLUDE_TGSW_DELETE_FUNCTION
#undef INCLUDE_TGSW_DELETE_FUNCTION
...
#if defined INCLUDE_ALL || defined INCLUDE_TGSW_DELETE_ARRAY_FUNCTION
#undef INCLUDE_TGSW_DELETE_ARRAY_FUNCTION
