...
public:
  ...
  void execute_reverse_torus64(double* res, const Torus64* a);

  void execute_direct_torus32(Torus32* res, const double* a);
  void execute_direct_torus64(Torus64* res, const double* a);
...
extern "C" void LagrangeHalfCPolynomialMul_asm(
  LagrangeHalfCPolynomial* result,
  const LagrangeHalfCPolynomial* a,
  const LagrangeHalfCPolynomial* b);

extern "C" void LagrangeHalfCPolynomialAddMul_asm(
  LagrangeHalfCPolynomial* accum,
  const LagrangeHalfCPolynomial* a,
  const LagrangeHalfCPolynomial* b);

extern "C" void LagrangeHalfCPolynomialSubMul_asm(
  LagrangeHalfCPolynomial* accum,
  const LagrangeHalfCPolynomial* a,
  const LagrangeHalfCPolynomial* b);
