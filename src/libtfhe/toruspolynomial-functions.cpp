...
// TorusPolynomial + TorusPolynomial
template<typename TORUS>
void TorusPolyFunctions<TORUS>::Add(TorusPolynomial<TORUS>* result, const TorusPolynomial<TORUS>* poly1, const TorusPolynomial<TORUS>* poly2) {
  const int N = poly1->N;
...
// TorusPolynomial - TorusPolynomial
template<typename TORUS>
void TorusPolyFunctions<TORUS>::Sub(TorusPolynomial<TORUS>* result, const TorusPolynomial<TORUS>* poly1, const TorusPolynomial<TORUS>* poly2) {
  const int N = poly1->N;
...
template<typename TORUS>
void TorusPolyFunctions<TORUS>::AddMulZ(TorusPolynomial<TORUS>* result, const TorusPolynomial<TORUS>* poly1, int p, const TorusPolynomial<TORUS>* poly2) {
  const int N = poly1->N;
  TORUS* r = result->coefsT;
  const TORUS* a = poly1->coefsT;
  const TORUS* b = poly2->coefsT;
...
// TorusPolynomial += p*TorusPolynomial
template<typename TORUS>
void TorusPolyFunctions<TORUS>::AddMulZTo(TorusPolynomial<TORUS>* result, const int p, const TorusPolynomial<TORUS>* poly2) {
  const int N = poly2->N;
  TORUS* r = result->coefsT;
  const TORUS* b = poly2->coefsT;
...
// TorusPolynomial - p*TorusPolynomial
template<typename TORUS>
void TorusPolyFunctions<TORUS>::SubMulZ(TorusPolynomial<TORUS>* result, const TorusPolynomial<TORUS>* poly1, const int p, const TorusPolynomial<TORUS>* poly2) {
  const int N = poly1->N;
  TORUS* r = result->coefsT;
  const TORUS* a = poly1->coefsT;
  const TORUS* b = poly2->coefsT;
...
//result= (X^{a}-1)*source
template<typename TORUS>
void TorusPolyFunctions<TORUS>::MulByXaiMinusOne(TorusPolynomial<TORUS>* result, int a, const TorusPolynomial<TORUS>* source) {
...
template<typename TORUS>
double TorusPolyFunctions<TORUS>::NormInftyDist(const TorusPolynomial<TORUS>* poly1, const TorusPolynomial<TORUS>* poly2) {
  const int N = poly1->N;
  double norm = 0;
